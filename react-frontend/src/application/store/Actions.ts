...
export function createAsyncAction<RequestPayload, SuccessPayload, FailurePayload>(
...
export interface AsyncActionCreator<RequestPayload, SuccessPayload, FailurePayload> {
