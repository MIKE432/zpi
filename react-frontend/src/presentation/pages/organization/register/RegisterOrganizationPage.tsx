...
import { ProgressBar } from "../../../../infrastructure/components/ProgressBar";
import { ProgressStepper, StepperStep } from "../../../../infrastructure/components/ProgressSteper";
import { Button, makeStyles } from "@material-ui/core";
import { CenteredContent } from "../../../../infrastructure/components/CenteredContent";
import { StyledDivRow } from "../../../../infrastructure/components/StyledComponents";
    ...
    return (
        <CenteredContent width="100%">
            ...
            <ProgressStepper
                ...
                skipped={ skipped }/>
            <form>
                <AboutOrganizationRegisterOrganizationSection isVisible={ activeStep === 0 } register={ register }
                                                              getValues={ getValues }/>
                <UniversityInfoSectionRegisterOrganization isVisible={ activeStep === 1 } register={ register }/>
                <AdditionalInfoRegisterOrganizationSection isVisible={ activeStep === 2 } register={ register }/>
                <PreviewRegisterOrganizationSection isVisible={ activeStep === 2 }/>
            </form>

            <StyledDivRow>
                <Button onClick={ handleBack } disabled={ activeStep === 0 }>Back</Button>
                <Button onClick={ handleNext }>{ activeStep === 3 ? 'Zarejestruj' : 'Next' }</Button>
            </StyledDivRow>
        </CenteredContent>
    )
}